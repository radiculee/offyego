...
export const localLadVoice: Voice = {
  ...
  radiusSliderLabel: '{walkTime}, lad',
  ...
  locationTimeoutMessages: [
    ...
    "Ten seconds and yer phone's still thinking. Give it another rattle.",
    "Took too long, lad. Happens to the best of phones. Again?",
    "Yer GPS took a little nap on us. Wake it up and try again.",
    "No joy in time, lad. Step outside and have another bash.",
    "The phone blinked. Give it another go.",
    "Timed out on ya. Step near a window and try again.",
    "Slow phone or bad spot. Either way, give it another go.",
  ],
  ...
  locationUnavailableMessages: [
    ...
    "Location's not playing ball. Try somewhere with a bit more sky.",
    "GPS can't see ya from in there. Step out for a sec.",
    "Location failed on us. Too much concrete maybe. Try again.",
    "Yer phone can't lock on. Step outside and we'll get sorted.",
    "Can't grab yer location. Roof's probably in the way. Try outside.",
    "Location service is not havin' it, lad. Give it another crack.",
    "No signal on yer whereabouts. Move and try again, we'll get there.",
  ],
  ...
  notFoundMessages: [
    ...
    "Took a wrong turn, did ya. Back to the main bit.",
    "Nothing here, lad. Head back and we'll sort ya out.",
    "Wrong door. The pub's not down this way.",
    "Ah no, dead end. Back to the start and we'll find one.",
    "Yer on the wrong road. Back the way ya came.",
    "Nothin' on this page, lad. Head back.",
    "Went the wrong way. Doesn't matter. Start again.",
  ],
  ...
  overpassErrorMessages: [
    ...
    "Can't grab the pub list right now. Try again in a tick.",
    "The map server's off having a little lie-down. Try again.",
    "Data's not coming through, lad. Give it a minute and we'll try again.",
    "Something's up with the pub finder. Not us. Try again shortly.",
    "Pub list is taking its time. Have patience and hit retry.",
    "Server's throwing shapes. Try again and it'll sort itself.",
    "Map data went on the blink. It'll come back. Try again.",
  ],
};
